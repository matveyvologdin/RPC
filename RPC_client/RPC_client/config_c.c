    ...
    /* [string][in] */ const unsigned char *path)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[0],
    ...
    /* [in] */ int mode)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[40],
                  ( unsigned char * )&IDL_handle);
    return ( int  )_RetVal.Simple;
    ...
    /* [in] */ int offset)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[104],
                  ( unsigned char * )&IDL_handle);
    return ( int  )_RetVal.Simple;
    ...
    /* [string][in] */ const unsigned char *password)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[162],
                  ( unsigned char * )&IDL_handle);
    return ( int  )_RetVal.Simple;
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[208],
                  ( unsigned char * )&IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&InterfaceRPC_StubDesc,
                  (PFORMAT_STRING) &config__MIDL_ProcFormatString.Format[236],
                  ( unsigned char * )&IDL_handle);
